package org.cloudbus.cloudsim.ext.gui.utils;
...
public class SimpleGraph extends JPanel {
	...
	private final Dimension GRAPH_DIM = new Dimension(780, 440);
	private final Dimension PANEL_DIM = new Dimension(800, 460);
	...
	public SimpleGraph(long[] dataValues, 
		...
		colWidth = (int) (GRAPH_DIM.getWidth() - 20) / 200;
